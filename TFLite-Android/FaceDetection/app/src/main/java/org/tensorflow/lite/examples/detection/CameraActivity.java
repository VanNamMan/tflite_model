...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected TextView faceInfoTextview,frameValueTextView, cropValueTextView, inferenceTimeTextView;
...
//  private boolean isDoneSwitchType = true;
...
//    });
    ...
    faceInfoTextview = findViewById(R.id.num_faces);
...
//      return;
    ...
    try {
      ...
      if (rgbBytes == null) {
        ...
        onPreviewSizeChosen(new Size(previewSize.width, previewSize.height), 90,TF_OD_API_INPUT_OBJ_DETECH_SIZE);
      }
...
//        characteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE = Camera.Size();
  ...
  protected void showFaceInfo(String faceInfo) {
