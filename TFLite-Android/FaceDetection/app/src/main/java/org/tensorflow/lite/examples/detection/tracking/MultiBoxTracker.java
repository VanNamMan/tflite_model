...
public class MultiBoxTracker {
  ...
  public final List<TrackedFace> trackedFaces = new LinkedList<TrackedFace>();
...
//    final List<RectF> rectsFaceToTrack = new LinkedList<RectF>();
